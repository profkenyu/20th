...
#ti-transfer-copy .destination-code{display:flex;justify-content:center;margin:0 auto 18px;
  --dot-size:clamp(2px,.25vw,4px);--dot-gap:clamp(1px,.11vw,2px);
  --dot-character-gap:clamp(3px,.32vw,6px);--dot-colour:#85f2a8;
  --dot-off:.045;--dot-on:.88;--dot-glow:5px}
...
export class PlanetTransfer {
  ...
  async update(now) {
    ...
    if (this.phase === 'blackout') {
      ...
      renderDotMatrix(this.copy.querySelector('.destination-code'), `P${planetNumber.padStart(2, '0')}`,
