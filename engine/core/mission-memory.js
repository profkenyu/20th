 ...
 * fields from it: eight material harmonics from BODY 01 and the confirmed
 * hydration spectrum from BODY 02.
 */

export const MISSION_MEMORY_VERSION = 1;
export const DEFAULT_MEMORY_KEY = 'terra-incognita:mission-memory:v1';
