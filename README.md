...
전체 작품은 세 행성을 하나의 보존 흐름으로 연결한다. PLANET 01의 구조재 5종과 질소·물·알코올 자원 3계통, PLANET 02의 수분 측정은 임무 기억에 남고, 격납된 로버와 착륙선은 Anime.js가 지휘하는 WebGPU 입자장으로 분해·압축·재조립된다. 두 기록의 위상 간섭은 PLANET 03에서 세 개의 지질 기억 교차 결절을 생성한다.
